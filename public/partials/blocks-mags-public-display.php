...
<div class="casino-score-block">
    <div class="casino-score-block__inner border-radius-25">
        <div class="casino-score-block__scores">
            <b class="casino-score-block__title"> <?php _e('CASINO SCORES', $this->domain) ?></b>
            <div class="casino-score-block__items">
                <?php echo $html_str ?>
            </div>
        </div>
        <div class="casino-score-block__overall">
            <b class="casino-score-block__title"><?php _e('OVERALL', $this->domain) ?></b><div class="casino-score-block__value-wrap">
